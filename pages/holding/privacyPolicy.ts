...
Body(Box(
    ...
    Box(
        ...
        Label(`BBN Holding and its subsidiaries and affiliates (collectively, “BBN”) are responsible for this website, including its mobile versions, and we are committed to respecting the privacy of visitors to both. BBN has implemented technical, administrative and physical measures to safeguard any personal information that we may collect.`),
        ...
        Label(`BBN may share your Personal Information with our subsidiaries and affiliated companies (the “BBN Group”). When BBN transfers your Personal Information within the BBN Group, it will do so consistent with applicable law and BBN’s Binding Corporate Rules, which are available above in many languages.`),
        Label(`In addition, BBN may provide access to or share Personal Information on an as-needed basis with third parties, such as trusted service providers, consultants and contractors who are granted access to BBN facilities or systems, and with government agencies and others as required by law. BBN will only share your information outside the BBN Group to:`),
        Box(
            Label(`allow service providers BBN has retained to perform services on our behalf. In those cases, BBN will only share the information with service providers for the purposes outlined above. These service providers are contractually restricted from using or disclosing the information except when it is necessary to perform services on our behalf or to comply with legal requirements;`),
            Label(`comply with legal obligations, including but not limited, to complying with tax and regulatory obligations, sharing data with labor/trade unions and works councils, and responding to a court proceeding or a legitimate legal request from law enforcement authorities or other government regulators;`),
            Label(`investigate suspected or actual illegal activity;`),
        ...
        Label(`In some instances, BBN may provide links to non-BBN controlled websites, which BBN will make reasonable efforts to identify as such. BBN does not control such third-party websites, however, and cannot be responsible for the content or the privacy practices employed by other websites.`),
        Label(`What additional information should specific users know?`, "h3"),
        Label("Parents, guardians and children:").setTextSize("base").setFontWeight("semibold").addClass("block"),
        Label(`This website is intended for visitors who are at least 18 years of age and the age of majority in their jurisdiction of residence. BBN does not knowingly solicit information from, or market products or services to, children. If you do not meet the age requirements set out above, please do not enter your personal information on this or any other BBN website.`),
        Label(`Residents of California:`).setTextSize("base").setFontWeight("semibold").addClass("block"),
        Label(`California Shine the Light Law:\xA0`).addClass("block"),
        Label(`California residents may annually request and obtain information that is shared with other businesses for their own direct marketing use within the prior calendar year. BBN does not share your personal information with other businesses for their own direct marketing use.`).addClass("block"),
        Label(`California Consumer Privacy Act:\xA0`).addClass("block"),
        Label(`Except for those who interact with BBN as employees and contractors, those whose information we have because of their relationship with employees and contractors (such as family members receiving health benefits or emergency contacts), job applicants, those whose information we have because of their relationship with job applicants (such as references), and those whose information we have as a result of a business-to-business interaction or relationship (such the personnel of a business customer or vendor), California residents have the right to`).addClass("block"),
        Box(
        ...
        Label(`If you are a California resident not covered by the exclusions mentioned above and you would like to exercise your rights, you should contact BBN by emailing us at support@bbn.one. Please provide your name, a way for BBN to contact you (such as an email address or telephone number) so that we can respond to your request, information about the nature of your relationship with us (for example, are you a visitor to our website or a shareowner), and details about the action that you would like us to take.\xA0 Based on your request, we will investigate to determine if we have any of your personal information. If we do have your personal information (other than that provided in your request), we will seek to verify your identity based on the personal information that we already have; the data we will request will depend on the nature of the personal information we have about you. Once we verify your identity, we will provide you with a response, indicating how we will satisfy your request or why we cannot comply with your request.`).addClass("block"),
        Label(`Users from the European Union and other countries with privacy laws:`).setTextSize("base").setFontWeight("semibold").addClass("block"),
        Label(`You have the right to lodge a complaint with your national or state supervisory authority. You also have the right to request access to and correction or erasure of your personal information, seek restrictions on or object to the processing of certain personal information, and seek data portability under certain circumstances. To contact BBN about a request to access, correct, erase, object or seek restrictions or portability, please use the contact methods indicated at the end of this notice.`).addClass("block"),
        Label(`Users from the United States:`).setTextSize("base").setFontWeight("semibold").addClass("block"),
        Label(`BBN does not collect Social Security Numbers through www.bbn.one. BBN does, however, collect Social Security Numbers where required by law, such as tax and payroll purposes for its employees. When BBN collects and/or uses Social Security Numbers, BBN will take proper care by protecting confidentiality, limiting collection, ensuring access on a need-to-know basis, implementing appropriate technical safeguards and ensuring proper disposal.`).addClass("block"),
        Label(`How might BBN change this policy?`, "h3"),
        Label(`As BBN expands and improves this website, we may need to update this policy. This policy may be modified from time to time without prior notice. We encourage you to review this policy on a regular basis for any changes. The date of the latest version will be identified at the bottom of the policy.`).addClass("block"),
        Label(`How can you contact BBN?`, "h3"),
        Label(`If you have any comments or questions, or if there are other things we can do to maximize the value of this website to you, please email support@bbn.one. If you wish to access, correct or update your personal information, or if you have questions about BBN’s privacy practices in general or a complaint, please email support@bbn.one.`).addClass("block"),
