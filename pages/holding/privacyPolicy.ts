...
View(() => Box(
    ...
    Box(
        ...
        Label("Parents, guardians and children:").setFont(1, 600).addClass("block"),
        ...
        Label(`Residents of California:`).setFont(1, 600).addClass("block"),
        ...
        Label(`Users from the European Union and other countries with privacy laws:`).setFont(1, 600).addClass("block"),
        ...
        Label(`Users from the United States:`).setFont(1, 600).addClass("block"),
