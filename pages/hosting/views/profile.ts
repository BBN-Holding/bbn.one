            ...
            Grid(
                ...
                Box(
                    Entry(
                        ...
                        .addClass("docked"),
                    meta.pricing.slots
                        ? ShopStack(meta.pricing.slots.price > meta.coins ? "Not enough Coins" : "Upgrade available", {
                ...
                Box(
                    Entry(
                        ...
                        .addClass("docked"),
                    meta.pricing.memory
                        ? ShopStack(meta.pricing.memory.price > meta.coins ? "Not enough Coins" : "Upgrade available", {
                ...
                Box(
                    Entry(
                        ...
                        .addClass("docked"),
                    meta.pricing.disk
                        ? ShopStack(meta.pricing.disk.price > meta.coins ? "Not enough Coins" : "Upgrade available", {
                ...
                Box(
                    Entry(
                        ...
                        .addClass("docked"),
                    meta.pricing.cpu
                        ? ShopStack(meta.pricing.cpu.price > meta.coins ? "Not enough Coins" : "Upgrade available", {
...
const ShopStack = (actionText: string, variant: ShopVariant) =>
    Grid(
        Label(actionText),
        Vertical(
            variant.type == "blocked" ? null : Button(variant.label)
